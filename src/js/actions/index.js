...
export const request_article_list = subreddit => ({
...
export const switchSupport = (accessToken, replyId, index) => dispatch => {
...
export const fetchComment = (accessToken, topicId, content, replyId) => dispatch => {
  const postContent = replyId ? `accesstoken=${accessToken}&content=${content}&replyId=${replyId}` : `accesstoken=${accessToken}&content=${content}`
